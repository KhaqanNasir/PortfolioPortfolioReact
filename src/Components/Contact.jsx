      ...
      <div className="container">
        <div className="row">
          <div className="contact background">
            ...
            <div class="emailSend">
                <a href="mailto:khaqannasir01@gmail.com" target="_blank" className="mail">Send Mail</a>
                <a href="https://drive.google.com/file/d/17_YXOt_OYG-dygd2DQZOWgFOIAvX0J8Q/view?usp=sharing" download target="_blank" className="mail">Download CV</a>
              </div>
          </div>
        </div>
      </div>
